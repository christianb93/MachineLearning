...
\end{align*}
Now, the characteristic property of a reservoir is that we can add heat without significantly raisings its temperature. Thus raising its temperature does not increase its energy (with other words, the heat capacity of the reservoir is infinite), meaning that the derivative of the temperature with respect to the energy is zero. Therefore the Taylor expansion contains only a linear term.
...
\exp (-\beta E(s))
$$
Now recall that $U$ to be the average, i.e. the macroscopically observed energy of our primary system. Therefore the quantity $U - TS$ is nothing but the Helmholtz potential of the primary system, and we obtain the fundamental equation
\begin{align*}
