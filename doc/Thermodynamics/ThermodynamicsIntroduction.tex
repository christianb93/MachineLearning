...
$$
Now this depends explicitly on $m$, but of course still on $T$ due to the factor $\beta$ in the exponential, and on any other parameters on which $E(s)$ depends, for instance an external field $B$. 	
